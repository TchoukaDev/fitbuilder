...
function makeExercise(name: string, exerciseId = "ex-1") {
    return { exerciseId, name, muscle: "Pectoraux", muscles: [], equipment: "Barre", description: null }
}

const exerciseData = { name: "Développé couché", muscle: "Pectoraux", muscles: [], equipment: "Barre", description: null }
