      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h1 className="text-3xl font-bold text-primary-900 mt-0! mb-2">
                {workout.name}
              </h1>
              {workout.description && (
            ...
            <span className="px-4 py-2 bg-primary-100 text-primary-700 font-semibold rounded-full truncate max-w-[150px] shrink-0">
              {workout.category}
            </span>
          </div>
